...
/**
 * @brief Copy the contents of a matrix into a new matrix
 * @param matrix (Matrix*) The matrix that is going to have its data copied
 * @return Matrix* to a copy of the matrix passed into the parameter. The new matrix
 * will be malloced and will rely on the user to call matrix_delete to free it.
*/
